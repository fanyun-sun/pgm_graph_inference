...
python train.py --train_set_name $1_small --mode marginal --epochs 50 --verbose True --model_name default

echo -e "\tRunning tests"
python run_exps.py --exp_name in_sample_$1 --epochs 10 --model_name factor_gnn_inference
